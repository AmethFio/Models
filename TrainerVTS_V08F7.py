...
class StudentTrainer(BasicTrainer):
    def __init__(self,
        ...
        self.loss_terms = ('LOSS', 'MU', 'LOGVAR', 'KL', 'FEATURE', 'IMG', 'CTR', 'DPT')
    ...
    def kd_loss(self, mu_s, logvar_s, mu_t, logvar_t):
        ...
        return latent_loss, mu_loss, logvar_loss, kl_loss
    ...
    def calculate_loss(self, data):
        ...
        latent_loss, mu_loss, logvar_loss, kl_loss = self.kd_loss(s_mu, s_logvar, t_mu, t_logvar)
