...
class StudentTrainer(BasicTrainer):
    def __init__(self,
        ...
        self.loss_terms = ('LOSS', 'MU', 'LOGVAR', 'FEATURE', 'RIMG', 'CIMG', 'CTR', 'DPT')
    ...
    def calculate_loss(self, mode, data):
        ...
        rimage_loss = self.mse(s_rimage, rimg) / s_rimage.shape[0]
        cimage_loss = self.bce(s_cimage, cimg) / s_cimage.shape[0]
